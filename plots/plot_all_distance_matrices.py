...
output_file = plots_dir / "all_distance_heatmaps.png"
...
if len(distance_files) == 0:
    raise ValueError("No distance matrices found.")

print(f"Found {len(distance_files)} distance matrices")
...
# FINALIZE
# -----------------------------
plt.suptitle("Distance Matrices Comparison", fontsize=16)
plt.tight_layout()
