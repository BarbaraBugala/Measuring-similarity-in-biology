...
# PATHS
# -----------------------------
mknn_file = RESULTS_DIR / "similarities" / MODEL_TYPE / "mknn_scores_baseline.csv"
plots_dir = PLOT_DIR
plots_dir.mkdir(parents=True, exist_ok=True)
output_file = plots_dir / MODEL_TYPE / "mknn_heatmaps_baseline.png"
...
plt.suptitle("Mutual kNN Baseline", fontsize=16, y=0.98)
