...
scores_file = RESULTS_DIR / "similarities" / MODEL_TYPE / "qsi_tsi_scores_baseline.csv"

plots_dir = PLOT_DIR / MODEL_TYPE
plots_dir.mkdir(parents=True, exist_ok=True)

qsi_output = plots_dir / "qsi_heatmap_baseline.png"
tsi_output = plots_dir / "tsi_heatmap_baseline.png"
...
plt.title("QSI Similarity Baseline")
...
plt.title("TSI Similarity Baseline")
plt.xticks(rotation=45, ha="right")
plt.yticks(rotation=0)
